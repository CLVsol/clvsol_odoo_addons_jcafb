...
class LabTestReportSetup(models.TransientModel):
    _name = 'clv.lab_test.report.setup'

    def _default_lab_test_request_ids(self):
        return self._context.get('active_ids')
    lab_test_request_ids = fields.Many2many(
        comodel_name='clv.lab_test.request',
        relation='clv_lab_test_request_lab_test_report_setup_rel',
    ...
    lab_test_type_ids = fields.Many2many(
        ...
        relation='clv_lab_test_type_lab_test_report_setup_rel',
    ...
    @api.multi
    def do_lab_test_report_setup(self):
        self.ensure_one()
