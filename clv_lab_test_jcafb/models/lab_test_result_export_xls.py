...
class LabTestResult(models.Model):
    ...
    def lab_test_result_export_xls_dir_path(self):
        return '/opt/openerp/clvsol_clvhealth_jcafb/lab_test_files/results/xls'

    def lab_test_result_export_xls_file_name(self):
        return 'Resultado_<type>_<request_code>.xls'
    ...
    def lab_test_result_export_xls(self, dir_path, file_name):
        ...
        #     for address_document in self.lab_test.result_address_document_ids:
        ...
        #     for address_person in self.lab_test.result_address_person_ids:
        ...
        #     for person_document in self.lab_test.result_person_document_ids:
        ...
        #     for person_lab_test_request in self.lab_test.result_person_lab_test_request_ids:
        ...
        #     for person_event in self.lab_test.result_person_event_ids:
