...
class LabTestOffReport(models.Model):
    ...
    def lab_test_off_report_export_xls(self, dir_path, file_name, use_template, template_dir_path):
        ...
        if lab_test_type == 'EAN20':
            self.lab_test_off_report_export_xls_EAN20(sheet, row_nr, logo_file_path, use_template)
            save_book = True

        if lab_test_type == 'EDH20':
            self.lab_test_off_report_export_xls_EDH20(sheet, row_nr, logo_file_path, use_template)
            save_book = True
