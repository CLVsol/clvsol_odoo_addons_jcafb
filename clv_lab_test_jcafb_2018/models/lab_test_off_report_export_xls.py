...
class LabTestOffReport(models.Model):
    ...
    def lab_test_off_report_export_xls(self, dir_path, file_name, use_template, template_dir_path):
        ...
        if lab_test_type == 'EAN18':
            self.lab_test_off_report_export_xls_EAN18(sheet, row_nr, logo_file_path, use_template)
            save_book = True

        if lab_test_type == 'EDH18':
            self.lab_test_off_report_export_xls_EDH18(sheet, row_nr, logo_file_path, use_template)
            save_book = True
