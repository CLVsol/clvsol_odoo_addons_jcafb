...
class LabTestReportEdit(models.TransientModel):
    ...
    def _default_EEV18_liberacao_reportado(self):
        return self._get_default('EEV18', 'EEV18-01-02')
    EEV18_liberacao_reportado = fields.Date(
        'Liberação do Reportado', readonly=False, default=_default_EEV18_liberacao_reportado
    )

    def _write_EEV18_liberacao_reportado(self):
        self._set_result('EEV18', 'EEV18-01-02', self.EEV18_liberacao_reportado)

    def _default_EEV18_reportado(self):
        return self._get_default('EEV18', 'EEV18-01-03')
    EEV18_reportado = fields.Selection([
        ('Positivo', 'Positivo'),
        ('NEGATIVO', 'NEGATIVO'),
        ('Não Realizado', 'Não Realizado'),
    ], 'Reportado', readonly=False, default=_default_EEV18_reportado)

    def _write_EEV18_reportado(self):
        self._set_result('EEV18', 'EEV18-01-03', self.EEV18_reportado)
    ...
    def _do_report_updt_EEV18(self):
        ...
        self._write_EEV18_liberacao_reportado()
        self._write_EEV18_reportado()
