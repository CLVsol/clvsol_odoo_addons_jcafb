...
class LabTestResultCopyToReport(models.TransientModel):
    ...
    def _write_EEV18_resultado(self):
        ...
        self._copy_result('EEV18', 'EEV18-01-03', self.EEV18_resultado)
    ...
    def _write_EEV18_metodo_utilizado(self):
        ...
        self._copy_result('EEV18', 'EEV18-01-05', self.EEV18_metodo_utilizado)
    ...
    def _write_EEV18_obs(self):
        ...
        self._copy_result('EEV18', 'EEV18-01-06', self.EEV18_obs)

    def _do_result_copy_to_report_EEV18(self):
