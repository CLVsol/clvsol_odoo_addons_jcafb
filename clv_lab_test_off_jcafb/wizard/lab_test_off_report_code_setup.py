...
class LabTestOffReportCodeSetUp(models.TransientModel):
    _name = 'clv.lab_test.off.report.code.setup'
    ...
    @api.multi
    def do_lab_test_off_report_code_setup(self):
        self.ensure_one()
        ...
        while count < self.quantity:
            ...
            lab_test_off_report_code = LabTestOffReportCode.create(values)
            lab_test_off_report_code.code = '/'
