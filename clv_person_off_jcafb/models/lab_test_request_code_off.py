...
class LabTestRequestCodeOff(models.Model):
    _description = 'Lab Test Request Code (Off)'
    _name = 'clv.lab_test.request.code_off'
    _inherit = 'clv.abstract.code'
    _rec_name = 'code'
    _order = 'code'

    code = fields.Char(string='Lab Test Request Code (Off)', required=False, default='/')
